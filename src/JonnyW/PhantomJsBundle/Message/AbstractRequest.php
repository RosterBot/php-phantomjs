...
use JonnyW\PhantomJSBundle\Exception\InvalidUrlException;
use JonnyW\PhantomJSBundle\Exception\InvalidMethodException;
...
*@param  string                                             $method
     *
*@return \JonnyW\PhantomJSBundle\Message\AbstractRequest
     * @throws \JonnyW\PhantomJSBundle\Exception\InvalidMethodException
     */
    public function setMethod($method)
    {
        $method     = strtoupper($method);
        $reflection = new \ReflectionClass('\JonnyW\PhantomJSBundle\Message\RequestInterface');
...
*@param  string                                          $url
     *
*@return \JonnyW\PhantomJSBundle\Message\AbstractRequest
     * @throws \JonnyW\PhantomJSBundle\Exception\InvalidUrlException
     */
