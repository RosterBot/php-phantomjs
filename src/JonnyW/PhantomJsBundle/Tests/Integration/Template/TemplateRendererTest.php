 ...
 */
namespace JonnyW\PhantomJSBundle\Tests\Integration\Template;

use JonnyW\PhantomJSBundle\Test\TestCase;
use JonnyW\PhantomJSBundle\Template\TemplateRenderer;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testRenderInjectsParameterIntoTemplateUsingObjectMethodWithParameter()
    {
        ...
        $renderer = $this->getInjectedTemplateRenderer();
        $renderer->render($template, ['request' => $request]);
    }
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
*@return \JonnyW\PhantomJSBundle\Message\TemplateRenderer
     */
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
     * @access protected
     * @return \JonnyW\PhantomJSBundle\Message\RequestInterface
     */
    protected function getRequest()
    {
        $mockRequest = $this->getMock('\JonnyW\PhantomJSBundle\Message\RequestInterface');
