 ...
 */
namespace JonnyW\PhantomJSBundle\Tests\Unit\Cache;

use JonnyW\PhantomJSBundle\Cache\FileCache;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testSaveThrowsNotWritableExceptionIfWriteFileReturnsFalse()
    {
        ...
        $fileCache = $this->getMockFileCache(['writeData'], $this->directory, 'txt');
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
*@return \JonnyW\PhantomJSBundle\Cache\FileCache
     */
...
*@return \JonnyW\PhantomJSBundle\Cache\FileCache
    ...
    {
        $mockFileCache = $this->getMock('\JonnyW\PhantomJs\Cache\FileCache', $methods, [$directory, $extension]);
