...
use JonnyW\PhantomJSBundle\Procedure\Procedure;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testRunThrowsNotWriteableExceptionIfProcedureExecutableFileCannotBeWritten()
    {
        ...
        $cache->expects($this->once())
            ->method('save')
            ->will($this->throwException(new \JonnyW\PhantomJSBundle\Exception\NotWritableException()));
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
     * @access protected
     * @return \JonnyW\PhantomJSBundle\ClientInterface
     */
