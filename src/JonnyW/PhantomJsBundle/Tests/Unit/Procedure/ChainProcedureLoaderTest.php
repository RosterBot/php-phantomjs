...
use JonnyW\PhantomJSBundle\Procedure\ChainProcedureLoader;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    {
        $chainProcedureLoader = $this->getChainProcedureLoader([]);
...
*@param  array                                            $procedureLoaders
     *
*@return \JonnyW\PhantomJSBundle\Procedure\ChainProcedureLoader
     */
